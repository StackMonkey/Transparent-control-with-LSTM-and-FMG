...
unsigned long previous_current_time_control = 0;
float loop_time = 0;
...
float initial_torque_MR_trajectory = 0;
float final_torque_MR_trajectory = 0;

float initial_torque_ML_trajectory = 0;
float final_torque_ML_trajectory = 0;
